...
@implementation SCOpenGLView (IBIntegration)
...
//        [NSArray arrayWithObjects:@"clearsColorBuffer", @"clearsDepthBuffer", nil]];
}

- (void)ibPopulateAttributeInspectorClasses:(NSMutableArray *)classes
{
  [super ibPopulateAttributeInspectorClasses:classes];
  [classes addObject:[SCOpenGLViewInspector class]];
}
